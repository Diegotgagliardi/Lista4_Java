...
public class Evento extends Servico {
  ...
  public Evento(String nome, String data, String local, int lotacaoMaxima, int qtdeIngressosVendidos,
  ...
  public String toString() {
    return "Evento [nome=" + getNome() + ", data=" + getData() + ", local=" + local + ", lotacaoMaxima=" + lotacaoMaxima
        + ", qtdeIngressosVendidos=" + qtdeIngressosVendidos + ", precoIngresso=" + precoIngresso + ", valor="
        + getValor() + "]";
  }
}
